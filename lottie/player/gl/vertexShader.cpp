const GLchar* vertexSource = 
    ...
    "          gltemp = ((layersRotate[0] * shapesRotate[0]) * (layersScale[0] * shapesScale[0]) * (layersTransform[0] * shapesTransform[0])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[1] * shapesRotate[1]) * (layersScale[1] * shapesScale[1]) * (layersTransform[1] * shapesTransform[1])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[2] * shapesRotate[2]) * (layersScale[2] * shapesScale[2]) * (layersTransform[2] * shapesTransform[2])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[3] * shapesRotate[3]) * (layersScale[3] * shapesScale[3]) * (layersTransform[3] * shapesTransform[3])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[4] * shapesRotate[4]) * (layersScale[4] * shapesScale[4]) * (layersTransform[4] * shapesTransform[4])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[5] * shapesRotate[5]) * (layersScale[5] * shapesScale[5]) * (layersTransform[5] * shapesTransform[5])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[6] * shapesRotate[6]) * (layersScale[6] * shapesScale[6]) * (layersTransform[6] * shapesTransform[6])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[7] * shapesRotate[7]) * (layersScale[7] * shapesScale[7]) * (layersTransform[7] * shapesTransform[7])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[8] * shapesRotate[8]) * (layersScale[8] * shapesScale[8]) * (layersTransform[8] * shapesTransform[8])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[9] * shapesRotate[9]) * (layersScale[9] * shapesScale[9]) * (layersTransform[9] * shapesTransform[9])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[10] * shapesRotate[10]) * (layersScale[10] * shapesScale[10]) * (layersTransform[10] * shapesTransform[10])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[11] * shapesRotate[11]) * (layersScale[11] * shapesScale[11]) * (layersTransform[11] * shapesTransform[11])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[12] * shapesRotate[12]) * (layersScale[12] * shapesScale[12]) * (layersTransform[12] * shapesTransform[12])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[13] * shapesRotate[13]) * (layersScale[13] * shapesScale[13]) * (layersTransform[13] * shapesTransform[13])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[14] * shapesRotate[14]) * (layersScale[14] * shapesScale[14]) * (layersTransform[14] * shapesTransform[14])) * gltemp; \n"
    ...
    "          gltemp = ((layersRotate[15] * shapesRotate[15]) * (layersScale[15] * shapesScale[15]) * (layersTransform[15] * shapesTransform[15])) * gltemp; \n"

...
function _emscripten_stack_unwind_buffer(addr, buffer, count) {
 ...
 for (var i = 0; i < count && stack[i + offset]; ++i) {
  SAFE_HEAP_STORE((buffer + i * 4 >> 2) * 4, _emscripten_generate_pc(stack[i + offset]), 4);
 }
 return i;
}
...
var _loadJson = Module["_loadJson"] = createExportWrapper("loadJson");
...
var _currentFrame = Module["_currentFrame"] = 431556;

var ___heap_base = Module["___heap_base"] = 6124336;
